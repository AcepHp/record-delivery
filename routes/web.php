...
Route::middleware('auth')->group(function () {
    ...
    // Maintenance
    Route::post('/maintenance/check-password', [MaintenanceController::class, 'checkPassword'])->name('maintenance.check_password');
    Route::get('/maintenance/backup-restore', [MaintenanceController::class, 'backupForm'])->name('maintenance.backup_restore.form');
    Route::post('/maintenance/backup', [MaintenanceController::class, 'backupData'])->name('maintenance.backup');
    Route::post('/maintenance/restore', [MaintenanceController::class, 'restoreData'])->name('maintenance.restore');
});
